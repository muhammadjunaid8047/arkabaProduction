        ...
        <div className="bg-white rounded-lg shadow-sm mb-8 border border-gray-200">
          <nav className="flex divide-x divide-gray-200">
            <button
              ...
              className={`flex-1 py-4 px-6 text-center font-medium text-sm flex items-center justify-center gap-2 ${
                activeTab === "contacts" ? "text-red-700 border-b-2 border-red-700 font-semibold" : "text-gray-500 hover:text-gray-700"
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 py-4 px-6 text-center font-medium text-sm flex items-center justify-center gap-2 ${
                activeTab === "involvements" ? "text-red-700 border-b-2 border-red-700 font-semibold" : "text-gray-500 hover:text-gray-700"
              }`}
            >
                  ...
                  <div key={contact._id} className="p-6 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="mt-2 text-sm text-gray-500">{contact.message}</p>
                      </div>
            ...
            <div className="divide-y divide-gray-200">
              {filteredData.length === 0 ? (
                ...
                filteredData.map((involved) => (
                  <div key={involved._id} className="p-6 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        <h2 className="text-lg font-semibold text-gray-900">
                          {involved.firstName} {involved.lastName}
                        </h2>
                        <p className="mt-1 text-sm text-gray-600">{involved.email}</p>
                        <div className="mt-2 grid grid-cols-2 gap-2 text-sm text-gray-500">
                          ...
                          {involved.otherInterest && (
                            <p className="col-span-2">
                              <span className="font-medium">Other:</span> {involved.otherInterest}
                            </p>
                          )}
                        </div>
                      </div>
